...
const App = () => {
    ...
    return (
        <div>
        <div >
        <ConfigBar setTimeDivDisplay={setTimeDivDisplay} setAmpDivDisplay={setAmpDivDisplay}/>
        </div>
        <div>
             <WebSocketComponent setReturnedValue={setSignalValue} />
        <div className = "display">
            <Display lastSignalValue={signalValue} timeDiv={timeDivDisplay} amplitudeDiv={ampDivDisplay}/>
        </div>
        </div>
        </div>
